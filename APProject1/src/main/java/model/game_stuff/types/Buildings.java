...
public enum Buildings {
    ...
    SMALLSTONEGATEHOUSE("Small stone gatehouse",0,0,0,0,1000,0,true),
    BIGSTONEGATEHOUSE("Big stone gatehouse",20,0,0,0,2000,0,true),
    DRAWBRIDGE("Drawbridge",0,10,0,0,1000,0,false),
    LOOKOUTTOWER("Lookout tower",10,0,0,0,1200,0,false),
    PREMITERTOWER("Premiter tower",10,0,0,0,1000,0,false),
    TURRET("Turret",15,0,0,0,1200,0,false),
    SQURETURRET("Squre turret",35,0,0,0,2500,0,true),
    CIRCULARTURRET("Circular turret",40,0,0,0,3000,0,true),
    ARMOURY("Armoury",0,5,0,0,200,0,false),
    BARRACK("Barrack",15,0,0,0,200,0,false),
    MERCENARYPOST("Mercenary post",0,10,0,0,200,0,false),
